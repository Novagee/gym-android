    ...
    public void draw(Canvas canvas) {
        ...
        if (mSections != null && mSections.length > 0) {
            ...
            if (mCurrentSection >= 0) {
                ...
                previewTextPaint.setColor(mResource.getColor(android.R.color.black));
                previewTextPaint.setAntiAlias(true);
                previewTextPaint.setTextSize(50 * mScaledDensity);
                
                //Added typeface
                Typeface tf = Typeface.createFromAsset(context.getAssets(), "HelveticaNeue-Bold.ttf");
                previewPaint.setTypeface(tf);
                ...
                canvas.drawRoundRect(previewRect, 0 * mDensity, 0 * mDensity, previewPaint);
            ...
            indexPaint.setColor(mResource.getColor(android.R.color.black));
