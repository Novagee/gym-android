...
public class EditProfileDataTask extends AsyncTask<MultipartEntity, Void, String>
{
	...
	public EditProfileDataTask(Context context, ClassAPIResponse apiResponse , String append_url , boolean is_loading)
	{
