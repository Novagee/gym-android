...
//		View v = inflater.inflate(R.layout.messages_layout, container, false);
	...
	public static BaseFragment newInstance(Context context,String tag){
		...
		if(TextUtils.equals(tag, Constant.FRAGMENT_FLAG_CHAT)){
			baseFragment = new ChatFragment();
		}else if(TextUtils.equals(tag, Constant.FRAGMENT_FLAG_FRIEND)){
			baseFragment = new FriendFragment();
		}else if(TextUtils.equals(tag, Constant.FRAGMENT_FLAG_EVENT)){
