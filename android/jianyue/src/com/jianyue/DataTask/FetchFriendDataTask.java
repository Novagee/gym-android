...
public class FetchFriendDataTask extends AsyncTask<String, Void, String>
{
	...
	private ArrayList<ClassFriend> friends_list;
	private boolean is_refresh = false;

	public FetchFriendDataTask(Context context, ClassAPIResponse apiResponse , String append_url , String page_no , String page_size , ArrayList<ClassFriend> friends_list , boolean is_refresh)
	{
		...
		try {
			...
			if(apiResponse.ack.equalsIgnoreCase("Success"))
			{
				...
				for(int i = 0 ; i < j_frineds.length() ; i++)
				{
					...
					ClassFriend obj = new ClassFriend();
