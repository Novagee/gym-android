...
public class ListViewLoader {
	...
	private void setDefaultValues() {
		if (mEmptyView==null) {
			mEmptyView = (ViewGroup) mInflater.inflate(R.layout.view_loader_empty, null);
		...
		if (mLoadingView==null) {
			mLoadingView = (ViewGroup) mInflater.inflate(R.layout.view_loader_loading, null);
		...
		if (mErrorView==null) {
			mErrorView = (ViewGroup) mInflater.inflate(R.layout.view_loader_error, null);
	 ...
	 */
	public ListViewLoader(Context context) {
		mContext = context;
